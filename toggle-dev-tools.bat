...
REM
REM Keeping the window open after a double-click is handled inside the PowerShell script, which
REM can see who launched it; a batch file only sees a command line, and a double-click's is nearly
