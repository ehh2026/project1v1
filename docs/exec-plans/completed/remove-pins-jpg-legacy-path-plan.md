...
| [refactoring-assessment-followthrough-plan.md](../active/refactoring-assessment-followthrough-plan.md) | Marker factory extraction should target the new two-path factory |
...
- [x] Panning/zooming does not cause composite markers to flicker back to drawn pins. → Closed by unzoomed Phase 7 manual smoke #2, #6 (2026-06-20)
...
| Composite on + pan/zoom | Full map and zoomed cluster | Markers remain composite; no restore-to-drawn flicker — closed by unzoomed Phase 7 smoke #2, #6 (2026-06-20) |
