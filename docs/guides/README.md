...
How the app works and how to operate it. Stable behavior lives here; future work lives in [exec-plans/active/](../exec-plans/active/).
...
| [TOUCH_SCREEN_SUPPORT.md](TOUCH_SCREEN_SUPPORT.md) | Touch input considerations (future) |
