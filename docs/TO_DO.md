...
- [ ] Manual layout edit on fully zoomed-out map — Edit Layout at full-map zoom (~1.0): enter edit mode, drag stub composite pin heads/endpoints, save/load layout for unzoomed individual markers (not cluster aggregates) — [composite-pins-unzoomed-plan.md](exec-plans/active/composite-pins-unzoomed-plan.md) Phase 6
