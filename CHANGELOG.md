...
- **Release planning:** Added the active Windows portable-release plan for a self-contained `win-x64` GitHub Release zip, safe user-supplied `Production-Content`, and release-local configuration tooling. Implementation, signing, installer/update support, and the .NET 8 migration remain pending.
