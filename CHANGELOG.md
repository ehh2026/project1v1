...
- **Zoomed-map upscaling design:** Defined DPI-correct physical-pixel settled rendering, source/DPI/resampler-aware cache identity, and Runtime Tuning comparisons for `Fant`, `Lanczos3`, `MitchellNetravali`, `Bicubic`, and restrained sharpened bicubic. Deferred lower/native-resolution zoom, higher-resolution or vector sources, vector overlays, and carefully validated offline neural super-resolution.
