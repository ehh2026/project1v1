...
- **Manual layout variants plan completed** — moved [manual-layout-variants-plan.md](docs/exec-plans/completed/manual-layout-variants-plan.md) to completed; updated [composite-pins-program.md](docs/exec-plans/active/composite-pins-program.md) dashboard; manual smoke passed 2026-06-08. `verify.ps1` taste check still fails on `Tools/PinDebugger/Program.cs` (1051 lines) — tracked in [TO_DO.md](docs/TO_DO.md) refactoring section.
