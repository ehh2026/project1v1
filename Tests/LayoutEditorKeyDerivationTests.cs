...
public class LayoutEditorKeyDerivationTests
{
    ...
    [Fact]
    public void SingleLocationZoom_PrefersAManualZoomedLayoutOverTheFullMapOne()
    {
        ...
        Assert.True(guardIndex >= 0, "The full-map replay must yield to a manual zoomed layout.");
